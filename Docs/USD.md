...
Since we now have an understanding of how to create several objects, it is time to break one of these objects into "rocks" to be later implemented with the model of a bucket. This is the beginning of our work with a type of particle and physics simulation. To do so, we took advantage of two different methods: Deformation of cubes and Cell Fracture division.

### Cell Fracture

A very helpful video that walks you through this process can be found [here](https://youtu.be/wvtbl9kgeKs?si=gxsOav0Wyf8MJ-pS).
